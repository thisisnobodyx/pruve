...
const statusCards = [
  {
    text: 'Lead captured',
    className:
      'top-[18%] right-[8%] xl:right-[12%] animate-float',
  },
  {
    text: 'WhatsApp replied',
    className:
      'top-[45%] left-[4%] xl:left-[10%] animate-float-delayed',
  },
  {
    text: 'Post scheduled',
    className:
      'bottom-[18%] right-[6%] xl:right-[14%] animate-float-delayed-2',
  },
];
...
export default function HeroSection() {
  return (
    <section className="relative h-screen w-full overflow-hidden bg-bg flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(3,3,3,0.4)_70%,rgba(3,3,3,0.8)_100%)]" />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <MagneticButton
            href="/contact"
            className="inline-flex items-center justify-center bg-accent text-white font-medium rounded-pill px-8 py-4 text-base transition-all duration-300 hover:shadow-[0_0_30px_rgba(168, 85, 247,0.3)] hover:brightness-110"
          >
            Book a Call
          </MagneticButton>
