...
const beforeMetrics = [
  { label: 'Apps to check', value: 5 },
  { label: 'Avg response time', value: 47, suffix: 'min' },
  { label: 'Messages missed/day', value: 12 },
];

const afterMetrics = [
  { label: 'Apps to check', value: 1 },
  { label: 'Avg response time', value: 30, suffix: 'sec' },
  { label: 'Messages missed/day', value: 0 },
];
        ...
        >
          <div className="bg-bg-card border border-border rounded-2xl p-10 max-w-2xl mx-auto">
            ...
            <p className="text-dim mb-8">
              Stop switching between apps. Start managing every channel from one powerful inbox.
            </p>
