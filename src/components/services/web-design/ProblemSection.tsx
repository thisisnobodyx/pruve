          ...
          <div className="relative w-full h-full flex items-center justify-center overflow-hidden px-4">
            ...
            >
              <div className="relative w-full max-w-[700px]">
                {/* Browser frame */}
                <div className="w-full bg-[#1a1a2e] border border-white/10 rounded-xl overflow-hidden shadow-2xl">
                  {/* Chrome bar */}
                  <div className="flex items-center gap-2 px-3 md:px-4 py-2 md:py-2.5 bg-[#12121f] border-b border-white/5">
                    ...
                    <div className="flex-1 mx-4 md:mx-8 bg-white/5 rounded px-3 py-1 text-[9px] md:text-[10px] text-white/30 text-center">
                      oldbusiness.com
                    </div>
                  </div>
                  ...
                  <div className="p-4 md:p-6 space-y-3 md:space-y-4 relative">
                    <div className="flex items-center justify-between">
                      <div className="text-white/20 text-[10px] md:text-xs font-bold">OLD LOGO</div>
                      <div className="flex gap-3">
                        <div className="w-8 md:w-10 h-2 rounded bg-white/10" />
                        <div className="w-8 md:w-10 h-2 rounded bg-white/10" />
                        <div className="w-8 md:w-10 h-2 rounded bg-white/10 hidden sm:block" />
                      </div>
                    </div>
                    <div className="mt-3 md:mt-4 space-y-2 md:space-y-3">
                      <div className="w-[80%] h-3 md:h-4 rounded bg-white/10" />
                      <div className="w-[60%] h-3 md:h-4 rounded bg-white/8" />
                      <div className="w-[40%] h-2 md:h-3 rounded bg-white/6 mt-2" />
                      <div className="mt-2 md:mt-3 w-24 md:w-32 h-6 md:h-7 rounded bg-white/8 border border-white/10" />
                    </div>
                    <div className="flex gap-2 mt-3 md:mt-4">
                      <div className="w-[30%] h-10 md:h-14 rounded bg-white/5 border border-white/10" />
                      <div className="w-[45%] h-10 md:h-14 rounded bg-white/5 border border-white/10" />
                      <div className="w-[20%] h-10 md:h-14 rounded bg-white/5 border border-white/10" />
                    </div>

                    {/* Red warning badges */}
                    <div
                      className="absolute top-2 md:top-4 right-2 md:right-4 bg-[#FF4545]/20 border border-[#FF4545]/30 rounded-lg px-2 md:px-3 py-1 md:py-1.5 text-[9px] md:text-[10px] text-[#FF4545] font-bold"
                      style={{ opacity: badgeOpacity, transform: `scale(${0.8 + badgeOpacity * 0.2})` }}
                    >
                      SLOW
                    </div>
                    <div
                      className="absolute bottom-2 md:bottom-4 right-2 md:right-4 bg-[#FF4545]/20 border border-[#FF4545]/30 rounded-lg px-2 md:px-3 py-1 md:py-1.5 text-[9px] md:text-[10px] text-[#FF4545] font-bold"
                      style={{ opacity: badgeOpacity, transform: `scale(${0.8 + badgeOpacity * 0.2})` }}
                    >
                      NO MOBILE
                    </div>
                    <div
                      className="absolute bottom-2 md:bottom-4 left-2 md:left-4 bg-[#FF4545]/20 border border-[#FF4545]/30 rounded-lg px-2 md:px-3 py-1 md:py-1.5 text-[9px] md:text-[10px] text-[#FF4545] font-bold"
                      style={{ opacity: badgeOpacity, transform: `scale(${0.8 + badgeOpacity * 0.2})` }}
                    >
                      0 LEADS
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 mt-4 md:mt-6" style={{ opacity: statCardOpacity }}>
                  {badStats.map((stat) => (
                    <div
                      key={stat.label}
                      className="bg-[#FF4545]/5 border border-[#FF4545]/15 rounded-xl p-2 md:p-3 text-center"
                    >
                      <div className="text-base md:text-lg mb-1">{stat.icon}</div>
                      <div className="text-white text-[10px] md:text-xs font-bold">{stat.label}</div>
                      <div className="text-[#FF4545] text-[9px] md:text-[10px] mt-0.5">{stat.sub}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="text-center w-full max-w-2xl">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-10">
                  {goodStats.map((stat, i) => (
                    <div
                      key={stat.label}
                      className="border rounded-xl p-3 md:p-4 text-center"
                      style={{
                    ...
                    >
                      ...
                      <div className="text-[10px] md:text-xs mt-1" style={{ color: ACCENT }}>{stat.sub}</div>
                    </div>
                  ))}
                </div>

                <div style={{ opacity: taglineOpacity, transform: `scale(${0.9 + taglineOpacity * 0.1})` }}>
                  <div className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-2 md:mb-3" style={{ color: ACCENT }}>
                    Built to convert.
                  </div>
                  <p className="text-dim text-base md:text-lg">Fast. Beautiful. Designed for results.</p>
                </div>
              </div>
            </div>
          </div>
