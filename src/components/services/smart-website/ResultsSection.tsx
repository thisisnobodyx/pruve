...
const beforeMetrics = [
  ...
  { label: 'Lead capture', value: 2, suffix: '%' },
  { label: 'Page speed', value: 42 },
];

const afterMetrics = [
  { label: 'Bounce rate', value: 24, suffix: '%' },
  { label: 'Lead capture', value: 12, suffix: '%' },
        ...
        >
          <div className="bg-bg-card border border-border rounded-2xl p-10 max-w-2xl mx-auto">
            ...
            <p className="text-dim mb-8">
              Get your AI-powered smart website live in weeks, not months. Start converting more visitors today.
            </p>
