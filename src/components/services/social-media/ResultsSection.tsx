...
const beforeMetrics = [
  { label: 'Hours on social/week', value: 16 },
  { label: 'Posts per week', value: 3 },
  { label: 'Follower growth/month', value: 2, suffix: '%' },
];

const afterMetrics = [
  { label: 'Hours on social/week', value: 1 },
  { label: 'Posts per week', value: 21 },
  { label: 'Follower growth/month', value: 15, suffix: '%' },
];
        ...
        >
          <div className="bg-bg-card border border-border rounded-2xl p-10 max-w-2xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-4">
              Ready to put your social media on{' '}
              <span style={{ color: ACCENT }}>autopilot?</span>
            </h3>
            <p className="text-dim mb-8">
              Join hundreds of businesses growing their social presence while they sleep.
            </p>
